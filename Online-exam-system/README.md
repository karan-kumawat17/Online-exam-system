...
INSTALLATION STEPS :
1. Put this file inside WAMP or XAMPP server.
2. Database Configuration
- Open phpmyadmin
- Create Database named project1​.
- Import database project1.sql from downloaded folder(inside database)
3. Open Your browser put inside "http://localhost/Online-Exam-System/"
4. To Login as admin put the following details.
- Admin Login Details
